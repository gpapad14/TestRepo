...
clocks = ['SCLK0','SCLK1','SCLK2','RG','PCLK0','PCLK1','PCLK2','PCLK3'] # For each clock there are 2 plots (rise and fall) 
clocks = []
...
if folder == '':
    folder = '/Users/gpapad/Downloads/singlecabac/data/4cabacvoltages'
